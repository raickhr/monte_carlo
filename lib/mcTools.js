...
module.exports = {
    theta: function(Graph,rootVertex,r){
        ...
        var second_exp = 0;
        //console.log('r',r);
        //console.log('rootVertex',rootVertex);
    ...
    getRandNode: function(noOfVertics,sourceNode){
        ...
        for (var i = 0; i < len;i++){
            AllPossibleDestNodes.push(i);
        }
        AllPossibleDestNodes.splice(AllPossibleDestNodes.indexOf(sourceNode),1);
        
        //console.log('AllPossibleDestNodes ',AllPossibleDestNodes);
        var randomIndex = Math.floor(Math.random()*AllPossibleDestNodes.length);
        var DestNode = AllPossibleDestNodes[randomIndex];
        //console.log('dest node',DestNode);
        return DestNode;
    },
