...
//console.log(X0.getShortestPaths(4));
//console.log(X0.noOfVertices);
//var X1 = mcTools.getRandGraph(X0);
// console.
// console.log(mcTools.theta(X0,X0.sourceNode,1));

//console.log(mcTools.mcHasting(X0,X1,1,1))
...
// sourceNode = X1.sourceNode;
//console.log(X1.adjMat);
//console.log(X0.getConnectedNodes(0));
//console.log(X0);
